...
public class Solution{
    public static void main(String[] args){
        TreeNode resEx1 = Solution.buildTree(new int[]{3,9,20,15,7}, new int[]{9,3,15,20,7});
        Solution.printTree(resEx1);
    }
    ...
    public static TreeNode buildTree(int[] preorder, int[] inorder) {
        Map<Integer, Integer> inorderMap = Solution.buildInorderMap(inorder);
        TreeNode root = Solution.helper(preorder, inorderMap, 0, 0, inorder.length - 1);
        return root;
    }
    ...
    public static TreeNode helper(int[] preorder, Map<Integer, Integer> inorderMap, int preStart, int inStart, int inEnd){
        ...
        newRoot.left = Solution.helper(preorder, inorderMap, preStart + 1, inStart, mid - 1);
        ...
        newRoot.right = Solution.helper(preorder, inorderMap, preStart + mid - inStart + 1, mid + 1, inEnd);
        return newRoot;

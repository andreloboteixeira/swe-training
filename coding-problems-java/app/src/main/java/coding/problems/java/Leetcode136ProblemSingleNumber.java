...
public class Leetcode136ProblemSingleNumber {
...
//    Each element in the array appears twice except for one element which appears only once.
    ...
    public static void main(String[] args){
        if(Leetcode136ProblemSingleNumber.singleNumber(new int[]{2,2,1}) == 1) {
            System.out.println("Ex 1 RIGHT");
        } else {
            System.out.println("Ex 1 WRONG");
        }

        if(Leetcode136ProblemSingleNumber.singleNumber(new int[]{4,1,2,1,2}) == 4) {
            System.out.println("Ex 2 RIGHT");
        } else {
            System.out.println("Ex 2 WRONG");
        }

        if(Leetcode136ProblemSingleNumber.singleNumber(new int[]{1}) == 1) {

...
public class Leetcode15ProblemThreeSum {
...
//    -10^5 <= nums[i] <= 10^5
    ...
    public static void main(String[] args) {
        ...
        List<List<Integer>> ex1Res = Leetcode15ProblemThreeSum.threeSum(ex1Input);
        ...
        List<List<Integer>> ex2Res = Leetcode15ProblemThreeSum.threeSum(ex2Input);
